...
async def cmd_start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "/analyse WTI — Analyser le pétrole\n"
        "/analyse GOLD — Analyser l'or\n"
        "/analyse CORN — Analyser le maïs\n"
        "/analyse CAC40 — Analyser le CAC 40\n"
        "/analyse DAX — Analyser le DAX\n"
        "/scan — Scanner tous les marchés\n"
        "/marches — Liste des marchés suivis\n"
        "/aide — Aide",
        parse_mode="Markdown"
    )
